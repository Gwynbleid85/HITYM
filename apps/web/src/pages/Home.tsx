          ...
          <Grid item xs={4}>
            <Paper variant="elevation" elevation={8} sx={{ m: 2 }}>
              <Box display="flex" alignContent="center" flexDirection="column">
                ...
                <Box
                  m={1}
                  sx={{ color: readyState === ReadyState.OPEN ? "green" : "black" }}
                  display="flex"
                  ...
                  message ? (
                    <ListItem key={index}>
                      <ListItemText
                        ...
                        style={{ color: stringToColour(message.sender) }}
                      />
                    </ListItem>
                  ) : (
                    ""
              ...
              <Grid container spacing={2}>
                <Grid item xs={4}></Grid>
                <Grid item xs={4}>
                  <Button variant="contained" onClick={() => updatePositionRelative(0.01, 0)} sx={{ m: 1 }}>
                    <KeyboardArrowUpIcon />
                  </Button>
                </Grid>
                <Grid item xs={4}></Grid>
                ...
                <Grid item xs={2}></Grid>
                <Grid item xs={2}>
                  <Button variant="contained" onClick={() => updatePositionRelative(0, -0.01)} sx={{ m: 1 }}>
